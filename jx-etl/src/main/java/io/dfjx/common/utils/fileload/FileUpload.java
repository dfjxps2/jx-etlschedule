...
import io.dfjx.common.utils.exception.FileFormatException;
import io.dfjx.common.utils.exception.NullFileException;
import io.dfjx.common.utils.exception.ProtocolException;
import io.dfjx.common.utils.exception.SizeException;
...
public class FileUpload {
	...
	public InputStream getUploadInputStream() 
			throws ProtocolException, NullFileException, SizeException, FileFormatException, IOException, FileUploadException{
		ServletFileUpload upload = getUpload(true);
		//解析request中的字段，每个字段(上传字段和普通字段)都会自动包装到FileItem中
		List<FileItem> fileItems = upload.parseRequest(this.request);
		for(FileItem item : fileItems){
			//如果不是普通字段
